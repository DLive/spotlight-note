...
//  noteBook
//
//  Created by DLive on 13-3-31.
//  Copyright (c) 2013年 DLive. All rights reserved.
//
...
Boolean GetMetadataForFile(void *thisInterface, CFMutableDictionaryRef attributes, CFStringRef contentTypeUTI, CFStringRef pathToFile)
{
    ...
    @autoreleasepool {
        ...
        if ([(__bridge NSString *)contentTypeUTI isEqualToString:@"me.dlive.mac.note"]) {//YOUR_STORE_FILE_UTI
            ...
            NSMutableArray* tree=[((__bridge NSMutableDictionary *)attributes) objectForKey:(id)kMDItemContentTypeTree];
            [tree addObject:@"public.text"];
            [tree addObject:@"public.plain-text"];
            [tree addObject:@"public.executable"];
            [tree addObject:@"public.item"];
            ((__bridge NSMutableDictionary *)attributes)[@"me_dlive_mac_note_title"] = @"123123";
                    ((__bridge NSMutableDictionary *)attributes)[(NSString *)kMDItemTextContent] = @"44444";
            ((__bridge NSMutableDictionary *)attributes)[(NSString *)kMDItemTitle] = @"fasdfadsfasdfasdfa";
            ((__bridge NSMutableDictionary *)attributes)[(NSString *)kMDItemTitle] = @"fasdfadsfasdfasdfa";
                    ok = TRUE;
            //    }
            //}
